...
//Class For add screen of bar graph
...
public class bar_graph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setting the color of the app bar
        RelativeLayout l=(RelativeLayout) findViewById(R.id.ll);
        l.setBackgroundColor(getResources().getColor(R.color.color4_sub));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent sub = new Intent(bar_graph.this, graph_add.class);
        bar_graph.this.startActivity(sub);
        finish();
        return false;
    }
