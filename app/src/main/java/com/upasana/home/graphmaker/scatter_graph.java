...
public class scatter_graph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.setBackgroundColor(getResources().getColor(R.color.color5_sub));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent sub = new Intent(scatter_graph.this, graph_add.class);
        scatter_graph.this.startActivity(sub);
        finish();
        return false;
    }
